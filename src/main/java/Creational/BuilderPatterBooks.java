...
public class BuilderPatterBooks {
    ...
    public static void main(String[] args) {
        BuilderPatterBooks books1 = new BuilderPatterBooks.BooksDetail().drama("This is Drama Book")
                                    .build();
        BuilderPatterBooks books2 = new BuilderPatterBooks.BooksDetail().fiction("This is fiction book")
